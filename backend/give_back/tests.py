...
class UserAuthTests(APITestCase):
    ...
    def setUp(self):
        # Set up a user and volunteer for testing
        self.user = User.objects.create_user(username='testuser', password='password123')
        self.volunteer = Volunteer.objects.create(user=self.user, bio='Test bio', location='Test location')

    def test_login_user_success(self):
        # Test login with correct credentials
        url = reverse('login_user')  # Ensure you use the name defined in urls.py
        ...
        self.assertNotIn('password', response.data['user'])  # Password should not be in response
    ...
    def test_update_volunteer_profile_success(self):
        ...
        self.client.login(username='testuser', password='password123')  # Log in the user first
        url = reverse('update_volunteer_profile')
        data = {
    ...
    def test_update_volunteer_profile_volunteer_not_found(self):
        ...
        # Delete the volunteer profile to simulate not found
        ...
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.data['error'], 'Volunteer profile not found')
